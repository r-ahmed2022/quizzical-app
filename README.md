...
# 📖 [Quiziccal] <a name="about-project"></a>

A simple quiz app using React , Trivia Opendb API and styling using CSS
...
- [Live Demo Link](https://r-ahmed2022.github.io/quizzical-app/)
...
[](https://r-ahmed2022.github.io/quizzical-app/)

2. Clone this repository to your desired folder:
you@your-Pc-name:~$ cd <folder>

3. Open the folder "quiziccal-app and run `npm install` to install all necesary scripts,
